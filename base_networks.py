...
class AttentionBlock(torch.nn.Module):
    def __init__(self, input_size, output_size):
        ...
        self.conv1 = ConvBlock(input_size, output_size, 1, 1, 0, activation=None, norm=None)
        self.conv2 = ConvBlock(output_size, output_size, 3, 1, 1, activation=None, norm=None)
        self.conv3 = ConvBlock(output_size, output_size, 3, 1, 1, activation=None, norm=None)
        self.conv4 = ConvBlock(output_size, output_size, 1, 1, 0, activation=None, norm=None)
